...
// import { Button, Flex, Heading, Image, Stack, Box, Text } from "@chakra-ui/react";
...
//                                 Dive into the dynamic world of HPNPAY distribution and experience the joy of high returns on your hard-earned money. Every investment here is a step towards a prosperous tomorrow.  Get High returns on money invested in HPNPAY distribution
//                                 business.
//                             </Text>
//                             <Text fontSize={{ base: "md", lg: "lg" }} color={"black.500"}>
//                                 <strong>  Zero Hassles, Maximum Benefits:</strong>
//                                 Forget Physical Stocks: Step into a business model where there's no need for tangible goods. No clutter, just clear profits.
//                             </Text>
//                             <Text fontSize={{ base: "md", lg: "lg" }} color={"black.500"}>
//                                 <strong> Save Big:</strong>
//                                 Say goodbye to hefty store space costs. Plus, no need for additional staff or the troubles of goods transfer. It's all digital, smooth, and efficient!
//                             </Text>
//                             <Text fontSize={{ base: "md", lg: "lg" }} color={"black.500"}>
//                                 <strong>  Empower Your Money:</strong>

//                                 Let your money work wonders for you. With HPNPAY, not only do you invest, but you also elevate your financial stature. Every penny here is a penny earned, and then some!                             </Text>
//                             <Text fontSize={{ base: "md", lg: "lg" }} color={"black.500"}>
//                                 <strong> Join the HPNPAY Revolution!:</strong>
//                                 Make the smart move and step into a world of unparalleled financial growth.
//                             </Text>

//                             <Text fontSize={{ base: "md", lg: "lg" }} color={"black.500"}>
//                                 Estimate Your Earnings - Dive into our intuitive Income Calculator
...
export default function Distributors() {
  ...
  return (
    <>
      <Box margin={'3rem'} background={"#f6f9fc"}>
        <Stack direction={{ base: "column", md: "row" }}>
          <Flex p={10} flex={1} align={"center"} justify={"center"}>
            <Stack spacing={6}>
              <Heading fontSize={{ base: "3xl", md: "4xl", lg: "5xl" }}>
