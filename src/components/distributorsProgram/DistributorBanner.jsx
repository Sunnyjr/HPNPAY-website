...
import Slider from "react-slick";
import img1 from "../../images/aboutUs_img/home.jpg";
// import img2 from "../../images/aboutUs_img/personal.png"
import img2 from "../../images/aboutUs_img/personal.png"
import img3 from "../../images/aboutUs_img/corporate.jpeg";
import travel from "../../images/aboutUs_img/travel.webp";
import aeps from "../../images/aboutUs_img/aeps.png";
      ...
      {/* <Box margin={{ base: "10px", md: "30px", lg: "50px" }}> */}
        ...
        >
          ...
          >
            <strong>
              ...
              Partnering with us means you're not just getting access to
              services; you're stepping into a world of potential. Here’s how
              you benefit:
            </strong>
            ...
            <li style={{ fontSize: "18px" }}>
              ...
              Get access to cutting-edge tech that empowers you and your
              retailers to serve customers efficiently.
            </li>
            <li style={{ fontSize: "18px" }}>
              <strong style={{ fontSize: "20px" }}>Training & Support:</strong>{" "}
              Benefit from comprehensive training and continuous support to
              ensure you and your network are always ahead.
            </li>
            <li style={{ fontSize: "18px" }}>
            ...
            <li style={{ fontSize: "18px" }}>
              ...
              Keep a finger on the pulse of your business with real-time
              reporting and tracking features. Dedicated Assistance: Our
              dedicated help desk ensures that your queries and issues are
              resolved, keeping your business running smoothly.
            </li>
            <li style={{ fontSize: "18px" }}>
              <strong style={{ fontSize: "20px" }}>Network Growth:</strong> As
              you grow your network of retailers, you're not just building
              business, you're enhancing communities.
            </li>
            <li style={{ fontSize: "18px" }}>
              <strong style={{ fontSize: "20px" }}>
        ...
        >
          ...
          fontSize={{ base: "20px", md: "22px" }}>
            Empower your retailers and give them an opportunity to increase
            their income and subsequently increase your income too.
          </Text>
          <Text 
        
          fontSize={{ base: "22px", md: "24px" }} fontWeight={"700"}>
